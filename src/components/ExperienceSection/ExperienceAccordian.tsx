                ...
                return (
                    <Accordion key={i} open={open === i} className="flex flex-col">
                        <AccordionHeader onClick={() => handleOpen(i)}>
                            <div className="rounded bg-background-950/20 hover:bg-background-950/40 border-[1px] border-secondary-800/40 h-15 px-5 py-3 flex items-center w-full space text-base justify-between hover:transform hover:scale-[1.01] ease-in-out duration-300">
                                <span>
                        ...
                        <AccordionBody>
                            <div className="bg-background-950/60 border-background-950/40 border-[1px] mt-2 px-5 py-3 flex flex-row justify-between">
                                <div className="w-3/4">
